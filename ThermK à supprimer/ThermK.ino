...
6 V -> température pour thermocouple K, routine mV2DegC_PQ  
*/
...
void loop()
{
  ...
  if (((unsigned int)millis() -t0) > 1000) 
  {
    t0+=1000;
    lcd.setCursor(0,1);            // move to the begining of the second line
//    lcd.print(R2DegC(4354));
//    lcd.print(mV2DegC(4.096),3);
//    lcd.print(mV2DegC_PQ(0.397),3);
    lcd.print(DegC2mV_PQ(25),3);
